...
export default function StudentDiscordTip() {
          ...
          <div className="flex justify-between items-start gap-3">
            <div className="flex gap-3">
              ...
              <p className="text-sm text-neutral05 leading-relaxed">
                You can enable{" "}
                <span className="font-semibold">Discord notifications</span> for
                work review updates by linking your Discord account in your
                profile settings
              </p>
            </div>
